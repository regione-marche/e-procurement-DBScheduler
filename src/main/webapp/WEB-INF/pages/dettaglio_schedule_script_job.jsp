...
<body>
	...
	<h1>Schedulazione dell'attivit&agrave; <s:property value="%{triggerScriptJobEntity.codscript}"/></h1></h1>
	...
	<s:form action="ScheduleScriptJobModifica" namespace="script_sql">
	
		Schedulazione Id <s:property value="%{triggerScriptJobEntity.id}"/>
		
		<s:textfield label="cron expression" name="cronexp" value="%{triggerScriptJobEntity.cronexp}" maxlength="20" />	

		<s:hidden name="id" value="%{triggerScriptJobEntity.id}"  />
		<s:hidden name="codscript" value="%{triggerScriptJobEntity.codscript}"  />
